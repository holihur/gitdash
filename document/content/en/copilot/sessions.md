---
title: "Sessions and issue fixes"
weight: 2
summary: "Create a session, chat, and auto-open a PR for a linked issue."
---
...
(`copilot-api/1`). The LLM is **bring your own key
...
- **Agent runtime** — the `agent` binary (built from the `deps/agent`
