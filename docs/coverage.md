...
| UI (Playwright) endpoint coverage | `scripts/ui-api-coverage.py` (frontend-called endpoints × route hits) | 91/192 (47.4%) | 100% of the UI-reachable surface |
...
extracted from the frontend (192 endpoints); Playwright covers 91 (47.4%) today.
