...
| UI (Playwright) endpoint coverage | `scripts/ui-api-coverage.py` (frontend-called endpoints × route hits) | 94/192 (49.0%) | 100% of the UI-reachable surface |
...
extracted from the frontend (192 endpoints); Playwright covers 94 (49.0%) today.
